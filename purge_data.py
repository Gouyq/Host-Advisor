...
listingCsv = pd.read_csv('../../data/airbnb/france/auvergne-rhone-alpes/lyon/2021-07-08/data/listings.csv', usecols=['id', 'listing_url', 'name', 'description', 'neighborhood_overview', 'picture_url',
                                                        'host_name', 'host_since', 'host_response_time', 'host_response_rate', 'host_acceptance_rate',
...
dataframe.to_csv('./airbnb_clean.csv', sep="‽", header=True, index=False)
